...
var azureMapsKey = 'CQU4Kd3iuv_ClVM2iSh3dRp8AV9bv1E6TcZIbP9fbMM';
    ...
    map.events.add('ready', function () {
        ...
        loadData('Confirmed').then(x => {
            ...
            document.getElementById('dataLabel').innerHTML = '<br/><br/>Data last updated: ' + currentDate.toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) +
                '<br/><br/>Data © Johns Hopkins University (<a target="_blank" href="https://github.com/CSSEGISandData/COVID-19">GitHub</a>)<br/><br/>Microsoft Future Ready talent Internship Final Project by Vivek Kumar</a>';
